  ...
  return (
    <nav className="bg-white p-5 px-10 flex justify-between items-center border-b border-b-[#0A0908]">
      ...
      <ul className="hidden md:flex font-[sans-serif]">
        ...
        <Link to="/posts" className="hover:bg-[#5E503F] hover:text-white pt-2 pb-2 pe-4 ps-4 transition-bg duration-400 rounded-sm cursor-pointer"><li>Posts</li></Link>
      </ul>
      ...
      {menuOpen && (
        <ul className="absolute top-[80px] left-0 w-full bg-white shadow-md flex flex-col items-center gap-4 py-4 md:hidden font-[sans-serif]">
          ...
          <Link to="/posts" className="hover:bg-[#5E503F] hover:text-white pt-2 pb-2 pe-4 ps-4 transition-bg duration-400 rounded-sm cursor-pointer"><li>Create Post</li></Link>
        </ul>
      )}
    </nav>
  );
